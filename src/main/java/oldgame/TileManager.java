...
public class TileManager {
    GamePanel gp;
    Tile[] tile;  // Stores amount of tile variants in the game
    int[][] mapTileNum;
    ...
    // Looks at map file and loads it
    ...
    public void draw(Graphics2D g2) {
        ...
        while (worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow) {
            ...
            // prevent rendering tiles outside the screen size
